...
y = 4381459.4593;
z = 4093731.0168;
file = fopen('D:\mycode\matcode\observationLEO.obs', 'w');
...
%    fprintf(file, '> 2019  1 10   9 %2d  %.8f  0 7                     ', floor(mod(t,60)), abs(t-floor(mod(t,60))));  
    ...
    for j = 1 : 8
        ...
        fprintf(file, '%s%14.3f%16.3f%16.3f%s%16.3f%16.3f%16.3f%s%16.3f%16.3f', prn(1+5*(j-1):5*j), P1(j,i), L1(j,i), 0, 0, P2(j,i), L2(j,i), 0, 0);
        fprintf(file,'\n');
    end
end
fclose(file);
