...
% rover_pos=[-2191682.743624 4417439.057935 4099763.903535];
...
Xplus1(1,1:9)=[-2173830  4381455  4093730 10 10 10];
...
% legend('X','Y','Z');
for i = 1:L
    r_r(i,:) = Xplus1(i,1:3) - rover_pos(:,i)';
