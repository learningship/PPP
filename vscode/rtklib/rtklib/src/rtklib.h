...
*			2021/03/26 1.12 rtklib ver.2.4.3 add armode
*-----------------------------------------------------------------------------*/
#ifndef RTKLIB_H
#define RTKLIB_H
#include <stdio.h>
...
#define FREQ1_LEO	5.02E9				/* LEO D1 frequency (Hz) */
#define FREQ2_LEO	7.07E9				/* LEO D2 frequency (Hz) */
...
#define MAXPRNLEO   1800                 /* max satellite sat number of LEO */
...
/*Ìí¼ÓÎÀÐÇÎ»ÖÃÖÓ²î*/
typedef struct {        /* satellite data */
    gtime_t time;       /* time (GPST) */
    int sat;            /*satellite*/
    double rs[6];       /* position/velocity (m|m/s) */
                        /* {x,y,z,vx,vy,vz} or {e,n,u,ve,vn,vu} */
