...
int main(int argc, char **argv)
{
    ...
    for (i=1,n=0;i<argc;i++) {
       ...
       // else if (n<MAXFILE) infile[n++]=argv[i];
        ...
        n = 7;
        infile[0] = "D:\\vscode\\rtklib-v1\\rtklib-v1\\new data\\bjfs0100.19n";
        infile[1] = "D:\\vscode\\rtklib-v1\\rtklib-v1\\new data\\bjfs0100.19o";
        infile[2] = "D:\\vscode\\rtklib-v1\\rtklib-v1\\new data\\igs20354.clk";
        infile[3] = "D:\\vscode\\rtklib-v1\\rtklib-v1\\new data\\igs20354.sp3"; 
        infile[4] = "D:\\vscode\\rtklib-v1\\rtklib-v1\\new data\\igsg0100.19i";
        infile[5] = "D:\\vscode\\rtklib-v1\\rtklib-v1\\new data\\igs20427.erp";
        infile[6] = "D:\\vscode\\rtklib-v1\\rtklib-v1\\new data\\igs14.atx";
